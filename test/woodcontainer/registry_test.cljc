(ns woodcontainer.registry-test
  (:require [clojure.test :refer [deftest is]]
            [woodcontainer.registry :as r]))
...
(deftest known-dimensional-specs-are-valid
  (doseq [spec [:crate-standard :crate-heavy-duty
...
(deftest fabricated-dimensional-spec-is-invalid
  (is (not (r/dimensional-spec-valid? :custom-oversize-shipping-cage)))
