# Operator Quickstart — Manufacture of wooden containers

Shortest path from clone to a verified local dry-run for **ISIC 1623** (`cloud-itonami-isic-1623`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1623.git
cd cloud-itonami-isic-1623
```
...
- Blueprint governor key: `wooden-container-shop-plant-operations-governor`
- Likely source path: `woodcontainer.governor.cljc`
