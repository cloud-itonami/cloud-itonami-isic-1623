# Business Model: Manufacture of wooden containers
...
## Classification
- Repository: `cloud-itonami-isic-1623` ([github.com/cloud-itonami/cloud-itonami-isic-1623](https://github.com/cloud-itonami/cloud-itonami-isic-1623))
- ISIC Rev.5: `1623` — Manufacture of wooden containers
- Domain: `:wood-products/wooden-containers`
- Social impact: :worker-safety :local-economy :resource-efficiency
- Actor: `:wooden-container-shop-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :wood-products/wooden-containers — who wants
...
One managed tenant (:wood-products/wooden-containers):
...
- Do not bypass the `:wooden-container-shop-plant-operations-governor` for production decisions.
